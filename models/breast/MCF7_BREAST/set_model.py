...
class DifferentialEquation(object):
    ...
    def diffeq(self, t, y, *x):
        ...
        v[50] = x[C.kf50] * y[V.E11P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr50] * y[V.E11P_ShcP_Grb2_PTP1B]
        v[51] = x[C.kf51] * y[V.E12P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr51] * y[V.E12P_ShcP_Grb2_PTP1B]
        v[52] = x[C.kf52] * y[V.E23P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr52] * y[V.E23P_ShcP_Grb2_PTP1B]
        v[53] = x[C.kf53] * y[V.E24P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr53] * y[V.E24P_ShcP_Grb2_PTP1B]
        v[54] = x[C.kf54] * y[V.E34P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr54] * y[V.E34P_ShcP_Grb2_PTP1B]
        v[55] = x[C.kf55] * y[V.E44P_ShcP_Grb2] * y[V.PTP1B] - x[C.kr55] * y[V.E44P_ShcP_Grb2_PTP1B]
        ...
        v[86] = x[C.kf86] * y[V.E11P_Grb2_SOS] * y[V.RasGDP] - x[C.kr86] * y[V.E11P_Grb2_SOS_RasGDP]
        v[87] = x[C.kf87] * y[V.E12P_Grb2_SOS] * y[V.RasGDP] - x[C.kr87] * y[V.E12P_Grb2_SOS_RasGDP]
        v[88] = x[C.kf88] * y[V.E23P_Grb2_SOS] * y[V.RasGDP] - x[C.kr88] * y[V.E23P_Grb2_SOS_RasGDP]
        v[89] = x[C.kf89] * y[V.E24P_Grb2_SOS] * y[V.RasGDP] - x[C.kr89] * y[V.E24P_Grb2_SOS_RasGDP]
        v[90] = x[C.kf90] * y[V.E34P_Grb2_SOS] * y[V.RasGDP] - x[C.kr90] * y[V.E34P_Grb2_SOS_RasGDP]
        v[91] = x[C.kf91] * y[V.E44P_Grb2_SOS] * y[V.RasGDP] - x[C.kr91] * y[V.E44P_Grb2_SOS_RasGDP]
        v[92] = x[C.kf92] * y[V.E11P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr92] * y[V.E11P_ShcP_Grb2_SOS_RasGDP]
        v[93] = x[C.kf93] * y[V.E12P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr93] * y[V.E12P_ShcP_Grb2_SOS_RasGDP]
        v[94] = x[C.kf94] * y[V.E23P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr94] * y[V.E23P_ShcP_Grb2_SOS_RasGDP]
        v[95] = x[C.kf95] * y[V.E24P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr95] * y[V.E24P_ShcP_Grb2_SOS_RasGDP]
        v[96] = x[C.kf96] * y[V.E34P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr96] * y[V.E34P_ShcP_Grb2_SOS_RasGDP]
        v[97] = x[C.kf97] * y[V.E44P_ShcP_Grb2_SOS] * y[V.RasGDP] - x[C.kr97] * y[V.E44P_ShcP_Grb2_SOS_RasGDP]
        v[98] = x[C.kf98] * y[V.E11P_Grb2_SOS_RasGDP] - x[C.kr98] * y[V.E11P_Grb2_SOS] * y[V.RasGTP]
        v[99] = x[C.kf99] * y[V.E12P_Grb2_SOS_RasGDP] - x[C.kr99] * y[V.E12P_Grb2_SOS] * y[V.RasGTP]
        v[100] = x[C.kf100] * y[V.E23P_Grb2_SOS_RasGDP] - x[C.kr100] * y[V.E23P_Grb2_SOS] * y[V.RasGTP]
        v[101] = x[C.kf101] * y[V.E24P_Grb2_SOS_RasGDP] - x[C.kr101] * y[V.E24P_Grb2_SOS] * y[V.RasGTP]
        v[102] = x[C.kf102] * y[V.E34P_Grb2_SOS_RasGDP] - x[C.kr102] * y[V.E34P_Grb2_SOS] * y[V.RasGTP]
        v[103] = x[C.kf103] * y[V.E44P_Grb2_SOS_RasGDP] - x[C.kr103] * y[V.E44P_Grb2_SOS] * y[V.RasGTP]
        v[104] = x[C.kf104] * y[V.E11P_ShcP_Grb2_SOS_RasGDP] - x[C.kr104] * y[V.E11P_ShcP_Grb2_SOS] * y[V.RasGTP]
        v[105] = x[C.kf105] * y[V.E12P_ShcP_Grb2_SOS_RasGDP] - x[C.kr105] * y[V.E12P_ShcP_Grb2_SOS] * y[V.RasGTP]
        v[106] = x[C.kf106] * y[V.E23P_ShcP_Grb2_SOS_RasGDP] - x[C.kr106] * y[V.E23P_ShcP_Grb2_SOS] * y[V.RasGTP]
        v[107] = x[C.kf107] * y[V.E24P_ShcP_Grb2_SOS_RasGDP] - x[C.kr107] * y[V.E24P_ShcP_Grb2_SOS] * y[V.RasGTP]
        v[108] = x[C.kf108] * y[V.E34P_ShcP_Grb2_SOS_RasGDP] - x[C.kr108] * y[V.E34P_ShcP_Grb2_SOS] * y[V.RasGTP]
        v[109] = x[C.kf109] * y[V.E44P_ShcP_Grb2_SOS_RasGDP] - x[C.kr109] * y[V.E44P_ShcP_Grb2_SOS] * y[V.RasGTP]
        ...
        v[135] = x[C.kf135] * y[V.E11P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr135] * y[V.E11P_Grb2_Gab1P_PTP1B]
        v[136] = x[C.kf136] * y[V.E12P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr136] * y[V.E12P_Grb2_Gab1P_PTP1B]
        v[137] = x[C.kf137] * y[V.E23P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr137] * y[V.E23P_Grb2_Gab1P_PTP1B]
        v[138] = x[C.kf138] * y[V.E24P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr138] * y[V.E24P_Grb2_Gab1P_PTP1B]
        v[139] = x[C.kf139] * y[V.E34P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr139] * y[V.E34P_Grb2_Gab1P_PTP1B]
        v[140] = x[C.kf140] * y[V.E44P_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr140] * y[V.E44P_Grb2_Gab1P_PTP1B]
        v[141] = x[C.kf141] * y[V.E11P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr141] * y[V.E11P_ShcP_Grb2_Gab1P_PTP1B]
        v[142] = x[C.kf142] * y[V.E12P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr142] * y[V.E12P_ShcP_Grb2_Gab1P_PTP1B]
        v[143] = x[C.kf143] * y[V.E23P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr143] * y[V.E23P_ShcP_Grb2_Gab1P_PTP1B]
        v[144] = x[C.kf144] * y[V.E24P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr144] * y[V.E24P_ShcP_Grb2_Gab1P_PTP1B]
        v[145] = x[C.kf145] * y[V.E34P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr145] * y[V.E34P_ShcP_Grb2_Gab1P_PTP1B]
        v[146] = x[C.kf146] * y[V.E44P_ShcP_Grb2_Gab1P] * y[V.PTP1B] - x[C.kr146] * y[V.E44P_ShcP_Grb2_Gab1P_PTP1B]
        v[147] = x[C.kf147] * y[V.PIP3_Gab1P] * y[V.PTP1B] - x[C.kr147] * y[V.PIP3_Gab1P_PTP1B]
        v[148] = x[C.kf148] * y[V.E11P_Grb2_Gab1P_PTP1B] - x[C.kr148] * y[V.E11P_Grb2_Gab1] * y[V.PTP1B]
        v[149] = x[C.kf149] * y[V.E12P_Grb2_Gab1P_PTP1B] - x[C.kr149] * y[V.E12P_Grb2_Gab1] * y[V.PTP1B]
        v[150] = x[C.kf150] * y[V.E23P_Grb2_Gab1P_PTP1B] - x[C.kr150] * y[V.E23P_Grb2_Gab1] * y[V.PTP1B]
        v[151] = x[C.kf151] * y[V.E24P_Grb2_Gab1P_PTP1B] - x[C.kr151] * y[V.E24P_Grb2_Gab1] * y[V.PTP1B]
        v[152] = x[C.kf152] * y[V.E34P_Grb2_Gab1P_PTP1B] - x[C.kr152] * y[V.E34P_Grb2_Gab1] * y[V.PTP1B]
        v[153] = x[C.kf153] * y[V.E44P_Grb2_Gab1P_PTP1B] - x[C.kr153] * y[V.E44P_Grb2_Gab1] * y[V.PTP1B]
        v[154] = x[C.kf154] * y[V.E11P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr154] * y[V.E11P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[155] = x[C.kf155] * y[V.E12P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr155] * y[V.E12P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[156] = x[C.kf156] * y[V.E23P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr156] * y[V.E23P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[157] = x[C.kf157] * y[V.E24P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr157] * y[V.E24P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[158] = x[C.kf158] * y[V.E34P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr158] * y[V.E34P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[159] = x[C.kf159] * y[V.E44P_ShcP_Grb2_Gab1P_PTP1B] - x[C.kr159] * y[V.E44P_ShcP_Grb2_Gab1] * y[V.PTP1B]
        v[160] = x[C.kf160] * y[V.PIP3_Gab1P_PTP1B] - x[C.kr160] * y[V.PIP3_Gab1] * y[V.PTP1B]
        v[161] = x[C.kf161] * y[V.E11P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr161] * y[V.E11P_Grb2_Gab1P_RasGAP]
        v[162] = x[C.kf162] * y[V.E12P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr162] * y[V.E12P_Grb2_Gab1P_RasGAP]
        v[163] = x[C.kf163] * y[V.E23P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr163] * y[V.E23P_Grb2_Gab1P_RasGAP]
        v[164] = x[C.kf164] * y[V.E24P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr164] * y[V.E24P_Grb2_Gab1P_RasGAP]
        v[165] = x[C.kf165] * y[V.E34P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr165] * y[V.E34P_Grb2_Gab1P_RasGAP]
        v[166] = x[C.kf166] * y[V.E44P_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr166] * y[V.E44P_Grb2_Gab1P_RasGAP]
        v[167] = x[C.kf167] * y[V.E11P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr167] * y[V.E11P_ShcP_Grb2_Gab1P_RasGAP]
        v[168] = x[C.kf168] * y[V.E12P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr168] * y[V.E12P_ShcP_Grb2_Gab1P_RasGAP]
        v[169] = x[C.kf169] * y[V.E23P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr169] * y[V.E23P_ShcP_Grb2_Gab1P_RasGAP]
        v[170] = x[C.kf170] * y[V.E24P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr170] * y[V.E24P_ShcP_Grb2_Gab1P_RasGAP]
        v[171] = x[C.kf171] * y[V.E34P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr171] * y[V.E34P_ShcP_Grb2_Gab1P_RasGAP]
        v[172] = x[C.kf172] * y[V.E44P_ShcP_Grb2_Gab1P] * y[V.RasGAP] - x[C.kr172] * y[V.E44P_ShcP_Grb2_Gab1P_RasGAP]
        ...
        v[180] = x[C.kf180] * y[V.E11P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr180] * y[V.E11P_Grb2_Gab1P_RasGAP_RasGTP]
        v[181] = x[C.kf181] * y[V.E12P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr181] * y[V.E12P_Grb2_Gab1P_RasGAP_RasGTP]
        v[182] = x[C.kf182] * y[V.E23P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr182] * y[V.E23P_Grb2_Gab1P_RasGAP_RasGTP]
        v[183] = x[C.kf183] * y[V.E24P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr183] * y[V.E24P_Grb2_Gab1P_RasGAP_RasGTP]
        v[184] = x[C.kf184] * y[V.E34P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr184] * y[V.E34P_Grb2_Gab1P_RasGAP_RasGTP]
        v[185] = x[C.kf185] * y[V.E44P_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr185] * y[V.E44P_Grb2_Gab1P_RasGAP_RasGTP]
        v[186] = x[C.kf186] * y[V.E11P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr186] * y[V.E11P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[187] = x[C.kf187] * y[V.E12P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr187] * y[V.E12P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[188] = x[C.kf188] * y[V.E23P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr188] * y[V.E23P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[189] = x[C.kf189] * y[V.E24P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr189] * y[V.E24P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[190] = x[C.kf190] * y[V.E34P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr190] * y[V.E34P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[191] = x[C.kf191] * y[V.E44P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr191] * y[V.E44P_ShcP_Grb2_Gab1P_RasGAP_RasGTP]
        v[192] = x[C.kf192] * y[V.PIP3_Gab1P_RasGAP] * y[V.RasGTP] - x[C.kr192] * y[V.PIP3_Gab1P_RasGAP_RasGTP]
        ...
        v[199] = x[C.kf199] * y[V.E11P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr199] * y[V.E11P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[200] = x[C.kf200] * y[V.E12P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr200] * y[V.E12P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[201] = x[C.kf201] * y[V.E23P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr201] * y[V.E23P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[202] = x[C.kf202] * y[V.E24P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr202] * y[V.E24P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[203] = x[C.kf203] * y[V.E34P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr203] * y[V.E34P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[204] = x[C.kf204] * y[V.E44P_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr204] * y[V.E44P_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[205] = x[C.kf205] * y[V.E11P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr205] * y[V.E11P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[206] = x[C.kf206] * y[V.E12P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr206] * y[V.E12P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[207] = x[C.kf207] * y[V.E23P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr207] * y[V.E23P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[208] = x[C.kf208] * y[V.E24P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr208] * y[V.E24P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[209] = x[C.kf209] * y[V.E34P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr209] * y[V.E34P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[210] = x[C.kf210] * y[V.E44P_ShcP_Grb2_Gab1P_RasGAP_RasGTP] - x[C.kr210] * y[V.E44P_ShcP_Grb2_Gab1P_RasGAP] * y[V.RasGDP]
        v[211] = x[C.kf211] * y[V.PIP3_Gab1P_RasGAP_RasGTP] - x[C.kr211] * y[V.PIP3_Gab1P_RasGAP] * y[V.RasGDP]
        v[212] = x[C.kf212] * y[V.E11P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr212] * y[V.E11P_Grb2_Gab1P_PI3K]
        v[213] = x[C.kf213] * y[V.E12P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr213] * y[V.E12P_Grb2_Gab1P_PI3K]
        v[214] = x[C.kf214] * y[V.E23P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr214] * y[V.E23P_Grb2_Gab1P_PI3K]
        v[215] = x[C.kf215] * y[V.E24P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr215] * y[V.E24P_Grb2_Gab1P_PI3K]
        v[216] = x[C.kf216] * y[V.E34P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr216] * y[V.E34P_Grb2_Gab1P_PI3K]
        v[217] = x[C.kf217] * y[V.E44P_Grb2_Gab1P] * y[V.PI3K] - x[C.kr217] * y[V.E44P_Grb2_Gab1P_PI3K]
        v[218] = x[C.kf218] * y[V.E11P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr218] * y[V.E11P_ShcP_Grb2_Gab1P_PI3K]
        v[219] = x[C.kf219] * y[V.E12P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr219] * y[V.E12P_ShcP_Grb2_Gab1P_PI3K]
        v[220] = x[C.kf220] * y[V.E23P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr220] * y[V.E23P_ShcP_Grb2_Gab1P_PI3K]
        v[221] = x[C.kf221] * y[V.E24P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr221] * y[V.E24P_ShcP_Grb2_Gab1P_PI3K]
        v[222] = x[C.kf222] * y[V.E34P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr222] * y[V.E34P_ShcP_Grb2_Gab1P_PI3K]
        v[223] = x[C.kf223] * y[V.E44P_ShcP_Grb2_Gab1P] * y[V.PI3K] - x[C.kr223] * y[V.E44P_ShcP_Grb2_Gab1P_PI3K]
        ...
        v[229] = x[C.kf229] * y[V.E11P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr229] * y[V.E11P_Grb2_Gab1P_PI3K_PIP2]
        v[230] = x[C.kf230] * y[V.E12P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr230] * y[V.E12P_Grb2_Gab1P_PI3K_PIP2]
        v[231] = x[C.kf231] * y[V.E23P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr231] * y[V.E23P_Grb2_Gab1P_PI3K_PIP2]
        v[232] = x[C.kf232] * y[V.E24P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr232] * y[V.E24P_Grb2_Gab1P_PI3K_PIP2]
        v[233] = x[C.kf233] * y[V.E34P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr233] * y[V.E34P_Grb2_Gab1P_PI3K_PIP2]
        v[234] = x[C.kf234] * y[V.E44P_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr234] * y[V.E44P_Grb2_Gab1P_PI3K_PIP2]
        v[235] = x[C.kf235] * y[V.E11P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr235] * y[V.E11P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[236] = x[C.kf236] * y[V.E12P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr236] * y[V.E12P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[237] = x[C.kf237] * y[V.E23P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr237] * y[V.E23P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[238] = x[C.kf238] * y[V.E24P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr238] * y[V.E24P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[239] = x[C.kf239] * y[V.E34P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr239] * y[V.E34P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[240] = x[C.kf240] * y[V.E44P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP2] - x[C.kr240] * y[V.E44P_ShcP_Grb2_Gab1P_PI3K_PIP2]
        v[241] = x[C.kf241] * y[V.PIP3_Gab1P_PI3K] * y[V.PIP2] - x[C.kr241] * y[V.PIP3_Gab1P_PI3K_PIP2]
        ...
        v[246] = x[C.kf246] * y[V.E11P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr246] * y[V.E11P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[247] = x[C.kf247] * y[V.E12P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr247] * y[V.E12P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[248] = x[C.kf248] * y[V.E23P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr248] * y[V.E23P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[249] = x[C.kf249] * y[V.E24P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr249] * y[V.E24P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[250] = x[C.kf250] * y[V.E34P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr250] * y[V.E34P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[251] = x[C.kf251] * y[V.E44P_Grb2_Gab1P_PI3K_PIP2] - x[C.kr251] * y[V.E44P_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[252] = x[C.kf252] * y[V.E11P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr252] * y[V.E11P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[253] = x[C.kf253] * y[V.E12P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr253] * y[V.E12P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[254] = x[C.kf254] * y[V.E23P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr254] * y[V.E23P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[255] = x[C.kf255] * y[V.E24P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr255] * y[V.E24P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[256] = x[C.kf256] * y[V.E34P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr256] * y[V.E34P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[257] = x[C.kf257] * y[V.E44P_ShcP_Grb2_Gab1P_PI3K_PIP2] - x[C.kr257] * y[V.E44P_ShcP_Grb2_Gab1P_PI3K] * y[V.PIP3]
        v[258] = x[C.kf258] * y[V.PIP3_Gab1P_PI3K_PIP2] - x[C.kr258] * y[V.PIP3_Gab1P_PI3K] * y[V.PIP3]
        ...
        v[291] = x[C.V291] * y[V.ERKPP] ** x[C.n291] / (x[C.K291] ** x[C.n291] + y[V.ERKPP] ** x[C.n291])
        ...
        v[310] = x[C.V310] * y[V.ERKPP] ** x[C.n310] / (x[C.K310] ** x[C.n310] + y[V.ERKPP] ** x[C.n310] + (y[V.cMycP] / x[C.KF310]) ** x[C.nF310])
        ...
        dydt[V.Grb2] = - v[16] - v[19] - v[22] - v[26] - v[30] - v[34] - v[38] - v[39] - v[40] - v[41] - v[42] - v[43]
        dydt[V.E11P_Grb2] = + v[16] - v[62] - v[74] - v[269]
        dydt[V.Shc] = - v[17] - v[20] - v[23] - v[27] - v[31] - v[35]
        dydt[V.E11P_Shc] = + v[17] - v[38] - v[270]
        dydt[V.RasGAP] = - v[18] - v[21] - v[25] - v[29] - v[33] - v[37] - v[161] - v[162] - v[163] - v[164] - v[165] - v[166] - v[167] - v[168] - v[169] - v[170] - v[171] - v[172] - v[173]
        ...
        dydt[V.PI3K] = - v[24] - v[28] - v[32] - v[36] - v[212] - v[213] - v[214] - v[215] - v[216] - v[217] - v[218] - v[219] - v[220] - v[221] - v[222] - v[223] - v[224]
        ...
        dydt[V.PTP1B] = - v[50] - v[51] - v[52] - v[53] - v[54] - v[55] + v[56] + v[57] + v[58] + v[59] + v[60] + v[61] - v[135] - v[136] - v[137] - v[138] - v[139] - v[140] - v[141] - v[142] - v[143] - v[144] - v[145] - v[146] - v[147] + v[148] + v[149] + v[150] + v[151] + v[152] + v[153] + v[154] + v[155] + v[156] + v[157] + v[158] + v[159] + v[160]
        ...
        dydt[V.SOS] = - v[62] - v[63] - v[64] - v[65] - v[66] - v[67] - v[68] - v[69] - v[70] - v[71] - v[72] - v[73] - v[118] + v[119]
        ...
        dydt[V.Gab1] = - v[74] - v[75] - v[76] - v[77] - v[78] - v[79] - v[80] - v[81] - v[82] - v[83] - v[84] - v[85] - v[120] + v[121] - v[259]
        ...
        dydt[V.RasGDP] = - v[86] - v[87] - v[88] - v[89] - v[90] - v[91] - v[92] - v[93] - v[94] - v[95] - v[96] - v[97] + v[193] + v[194] + v[195] + v[196] + v[197] + v[198] + v[199] + v[200] + v[201] + v[202] + v[203] + v[204] + v[205] + v[206] + v[207] + v[208] + v[209] + v[210] + v[211]
        ...
        dydt[V.RasGTP] = + v[98] + v[99] + v[100] + v[101] + v[102] + v[103] + v[104] + v[105] + v[106] + v[107] + v[108] + v[109] - v[174] - v[175] - v[176] - v[177] - v[178] - v[179] - v[180] - v[181] - v[182] - v[183] - v[184] - v[185] - v[186] - v[187] - v[188] - v[189] - v[190] - v[191] - v[192]
        ...
        dydt[V.PIP2] = - v[225] - v[226] - v[227] - v[228] - v[229] - v[230] - v[231] - v[232] - v[233] - v[234] - v[235] - v[236] - v[237] - v[238] - v[239] - v[240] - v[241] + v[260]
        ...
        dydt[V.PIP3] = + v[242] + v[243] + v[244] + v[245] + v[246] + v[247] + v[248] + v[249] + v[250] + v[251] + v[252] + v[253] + v[254] + v[255] + v[256] + v[257] + v[258] - v[259] - v[260]
